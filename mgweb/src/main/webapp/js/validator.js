...
+function ($) {
  ...
  Validator.prototype.showErrors = function ($el) {
    ...
    this.defer($el, function () {
      var $group = $el.closest('.has-feedback');
      ...
      var $addon = $group.find('span.input-group-addon');
      console.log('$addon.width(): ' + $addon.width());	
      //End MJGP
      ...
      //Start MJGP fix position feedback relative to input 
      $feedback.css('right', $group.width() - $input.width() - $feedback.width() - $addon.width() - $addon.width() - $addon.width());
      //End MJGP fix position feedback relative to input
    });
  };
  ...
  Validator.prototype.clearErrors = function ($el) {
    ...
    //MJGP fix position feedback relative to input 
    $feedback.css('right', $group.width() - $input.width() - $feedback.width() - $addon.width() - $addon.width() - $addon.width());
  };
