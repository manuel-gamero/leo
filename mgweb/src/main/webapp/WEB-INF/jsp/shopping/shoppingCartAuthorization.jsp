	...
	<div class="container">
		<div class="col-md-12">
			...
			<ul class="breadcrumb">
				...
				<li><s:text name="bolsos.shoppingcart.authorization"/></li>
			</ul>
		</div>
		<div class="col-md-6">
			<div class="box">
				...
				<hr>
				<s:form id="registerForm" action="registerUserShoppingCart" namespace="/user" method="post"
						...
						<div class="row">
							<div class="col-md-4 has-feedback">
								<s:textfield id="firstName" name="user.firstName"
									class="required form-control register-form" type="text"
							...
							<div class="col-md-4 has-feedback">
								<s:textfield id="lastName" name="user.lastName"
									class="form-control col-md-offset-1 register-form" type="text"
						...
						<div class="row">
							<div class="col-md-9 has-feedback">
								<s:textfield id="email" name="user.email" type="email"
									class="form-control register-form" placeholder="%{getText('bolsos.createaccount.label.email')}" 
					...
					<div class="form-group">
						...
						<div class="row">
						    <div class="col-md-5 has-feedback">
						      	...
						      	data-minlength="6" class="form-control register-form" id="inputPassword" 
						    ...
						    <div class="col-md-5 has-feedback">
						      	<s:textfield type="password" class="form-control register-form" 
						...
						<div class="row">
							<div class="col-md-5 has-feedback">
								<s:textfield id="address" name="userAddress.street" type="text"
									class="form-control register-form" placeholder="%{getText('bolsos.createaccount.label.street')}" 
						...
						<div class="row">
							<div class="col-md-5 has-feedback">
								<s:textfield id="city" name="userAddress.city" type="text"
									class="form-control register-form" placeholder="%{getText('bolsos.createaccount.label.city')}" 
									data-error="%{getText('bolsos.createaccount.error.label.mandatory')}" required=""/>
								<span aria-hidden="true" class="glyphicon form-control-feedback"></span>
						    	<small class="help-block with-errors"></small>
							</div>
							<div class="col-md-5 has-feedback">
								<s:textfield id="postCode" name="userAddress.postCode" type="text"
									class="form-control register-form" placeholder="%{getText('bolsos.createaccount.label.postCode')}" 
									data-error="%{getText('bolsos.createaccount.error.label.mandatory')}" required=""/>
								<span aria-hidden="true" class="glyphicon form-control-feedback"></span>
						    	<small class="help-block with-errors"></small>
							</div>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-3">
								<s:textfield id="phone" name="user.phone" class="required form-control register-form" type="text"
					...
					<div class="form-group">	
						<div class="row">   
							...
							<div class="col-md-3 has-feedback">  
								<s:select id="country" cssStyle="width:156px;" name ="userAddress.country" class="form-control register-form" list="#{}" listKey="id" listValue = "code"  emptyOption="true"/>
							</div>
						</div>
					</div>
					<div class="form-group">
						<div class="row">	   
							...
							<div class=" col-md-3 has-feedback">  
								...
								class="form-control register-form" list="#{}" listKey="id" listValue = "code"  emptyOption="true"
								data-error="%{getText('bolsos.createaccount.error.label.mandatory')}" required=""/>
							</div>
						</div>
					</div>
		...
		<div class="col-md-6">
			<div class="box">
				<h1><s:text name="bolsos.shoppingcart.authorization.login.title" /></h1>

				<p class="lead"><s:text name="bolsos.shoppingcart.authorization.paragraph4"/></p>
				<hr>

				<form id="loginForm" action="/user/loginShoppingCart" method="post"
						class="form-horizontal form-signin" data-toggle="validator"
						...
						<div class="row">
							<div class="col-md-3">
								<label for="login" class="control-label">
									<s:text name="bolsos.signin.login"/>
								</label>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3 has-feedback">
								<div class="input-group">
						        	...
						        	<s:textfield id="usernameRegister" name="username" type="text" 
						        		placeholder="%{getText('bolsos.signin.login')}" required="" 
						        		autofocus="true" class="form-control user-field login-form"
						        		data-remote="/user/validateLogin"
						        		data-error="%{getText('bolsos.signin.error.label.user')}" 
						        		aria-describedby="userico" cssStyle="width: 250px;"/>
						        </div>
					        	<span aria-hidden="true" class="glyphicon form-control-feedback"></span>
					        	<span class="sr-only" id="username">(success)</span>
								<small class="help-block with-errors"></small>
					...
					<div class="form-group">
						<div class="row">
							<div class="col-md-3">
								<label for="password" class="control-label">
									<s:text name="bolsos.signin.password"/>
								</label>
							</div>
						</div>
						<div class="row">
							<div class="col-md-3 has-feedback">
								<div class="input-group">
						        	...
						        	<s:password id="passwordRegister" name="password" type="password" 
						        		placeholder="%{getText('bolsos.signin.password')}" required=""
						        	   	data-error="%{getText('bolsos.signin.error.label.user')}"   
						        		class="form-control login-form" cssStyle="width: 250px;"/>
						        </div>
					        	<span aria-hidden="true" class="glyphicon form-control-feedback"></span>
						        <span class="sr-only" id="password">(success)</span>
								<small id="msgErrorRegister" class="help-block with-errors"></small>
					     	</div>
						</div>
					</div>
					<div class="text-center">
						<button id="loginButtonRegister" type="button" class="btn btn-primary">
							<i class="fa fa-sign-in"></i> <s:text name="bolsos.signin.button.signin" />
						</button>
					</div>
				</form>
			</div>
...
$(document).ready(function () {
	...
	$("#loginButtonRegister").click(function() {
		$.getJSON("/ajax/validatePassword", {
			username : $("#usernameRegister").val(),
			password : $("#passwordRegister").val()
		}, function(a) {
			if(a.resutl == "ERROR"){
				var textError = $("#passwordRegister").attr("data-error");
				$("#msgErrorRegister").text(textError);
			}
			else{
				$("#loginForm").submit();
			}				
	...
	$( ".login-form" ).focus(function() {
		$('#registerForm').validator('destroy');
		$('#loginForm').validator();
	});
